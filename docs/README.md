...
- 🏛️ [Full-Stack Integration Architecture](./architecture/Backend-Database-Frontend-Integration.md) - Folder layout, Express server API, and SQLite database schema.
