...
import { Clock, CheckCircle, AlertCircle, MapPin, Download, Filter, Search, Check, FileSpreadsheet, Bell, AlertTriangle } from 'lucide-react';
...
import { syncLocalData, clearNotifications, fetchAttendanceDataThunk } from '../../../store/attendanceSlice';
...
export const AttendanceManagement: React.FC = () => {
  ...
  return (
    <RoleGuard allowedRoles={[Role.ADMIN, Role.HR, Role.MANAGER, Role.TEAM_LEAD, Role.EMPLOYEE]} requiredPermission={Permission.ATTENDANCE_MANAGE}>
