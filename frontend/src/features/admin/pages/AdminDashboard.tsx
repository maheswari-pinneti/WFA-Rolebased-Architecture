        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <MinimalKpiCard
              ...
              iconBgColor="blue"
              trend="+96.0% active shift"
              trendType="positive"
              onClick={() => openDrillDown('Active Duty Status', '240 Clocked In', 'Real-time shift roster', [
                { label: 'In-Office Campuses', value: 180 },
                { label: 'Remote WFH', value: 60 },
              ])}
            />
          ...
          <div className="lg:col-span-2 p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl space-y-4">
            ...
            <div className="space-y-3 text-xs">
              {[
                ...
                { title: 'Attendance marked for 240 employees', time: '1h ago', user: 'System Automated', badge: 'Attendance', color: 'text-blue-400 bg-blue-500/10' },
