...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 md:grid-cols-2 bg-slate-950 text-slate-100 font-sans">
      {/* LEFT COLUMN: Executive Side Panel Branding */}
      <div className="p-8 lg:p-14 bg-gradient-to-br from-blue-700 via-indigo-900 to-slate-950 text-white flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 my-8 space-y-5 max-w-lg">
          ...
          <p className="text-blue-100/90 text-xs lg:text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <div className="p-3 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md flex items-center gap-3">
              <div className="p-2 rounded-xl bg-blue-500/30 text-blue-200 shrink-0">
                <Users size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-white truncate">Employee Directory</p>
                <p className="text-[10px] text-blue-200 truncate">Lifecycle & Profiles</p>
              </div>
            </div>

            <div className="p-3 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md flex items-center gap-3">
              <div className="p-2 rounded-xl bg-purple-500/30 text-purple-200 shrink-0">
                <Clock size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-white truncate">Real-Time Attendance</p>
                <p className="text-[10px] text-blue-200 truncate">Roster & Clock-Ins</p>
              </div>
            </div>

            <div className="p-3 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md flex items-center gap-3">
              <div className="p-2 rounded-xl bg-emerald-500/30 text-emerald-200 shrink-0">
                <TrendingUp size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-white truncate">Performance KPIs</p>
                <p className="text-[10px] text-blue-200 truncate">Quarterly Matrix</p>
              </div>
            </div>

            <div className="p-3 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md flex items-center gap-3">
              <div className="p-2 rounded-xl bg-amber-500/30 text-amber-200 shrink-0">
                <Building2 size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-white truncate">Department DBAC</p>
      ...
      {/* RIGHT COLUMN: Side-by-Side Authentication Card */}
      <div className="p-8 lg:p-14 flex items-center justify-center bg-slate-950">
        <div className="max-w-md w-full space-y-6 bg-slate-900/90 p-8 rounded-3xl border border-slate-800 shadow-2xl relative">
          ...
          {/* Error Message Alert */}
          {error && (
            <div className="p-3 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs flex items-center gap-2.5 animate-fadeIn">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4 pt-2">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors shadow-inner"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={timer > 0}
                  className="text-[11px] text-blue-400 hover:underline font-bold disabled:opacity-50"
                >
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-xs font-mono text-slate-100 placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors shadow-inner tracking-widest"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-xs shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {isLoading ? (
