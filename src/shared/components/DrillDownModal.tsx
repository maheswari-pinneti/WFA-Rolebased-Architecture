...
import { X, Layers, Download, FileText, Filter, ShieldCheck, Building2, UserCheck, Search } from 'lucide-react';
      ...
      <div className="w-full max-w-4xl glass-panel bg-slate-900 border-slate-700 shadow-2xl rounded-2xl overflow-hidden flex flex-col max-h-[90vh] text-slate-100">
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="p-4 rounded-xl bg-slate-800/40 border border-slate-800 space-y-3">
            ...
            {/* Filter Dropdowns for Roles & Departments */}
          ...
          {/* Granular Records Table with Role & Department Columns */}
                ...
                {filteredRecords.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={6} className="px-4 py-6 text-center text-slate-400 italic">
                      No matching records found for the selected department and role filters.
                    </td>
                  </tr>
                )}
              </tbody>
